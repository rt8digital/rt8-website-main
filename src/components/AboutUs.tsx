...
const AboutUs: React.FC<AboutUsProps> = ({ setCurrentPage }) => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative pt-20 sm:pt-32 pb-16 sm:pb-32">
      <div className="max-w-6xl mx-auto px-2 sm:px-4">
        ...
        <div className={`text-center mb-8 sm:mb-16 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h1 className="text-2xl sm:text-4xl md:text-6xl font-bold mb-4 sm:mb-6 mobile-heading">
            ...
            <span className="text-red-500 ml-2 sm:ml-4">RT8 ROTATE GROUP</span>
          </h1>
          <div className="w-16 sm:w-24 h-1 bg-red-500 mx-auto mb-4 sm:mb-8"></div>
          <p className="text-sm sm:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed mobile-text-shadow px-2">
        ...
        <div className={`mb-8 sm:mb-16 transition-all duration-1000 delay-200 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="mobile-card rounded-lg p-4 sm:p-8">
            <h2 className="text-xl sm:text-3xl font-bold text-white mb-4 sm:mb-6 text-center mobile-heading">Our Story</h2>
        ...
        <div className={`mb-8 sm:mb-16 transition-all duration-1000 delay-400 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h2 className="text-xl sm:text-3xl font-bold text-center text-white mb-6 sm:mb-12 mobile-heading">Our Impact</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className="text-red-500 font-semibold mb-1 sm:mb-2 text-xs sm:text-base">{stat.label}</div>
        ...
        <div className={`mb-8 sm:mb-16 transition-all duration-1000 delay-600 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="grid md:grid-cols-3 gap-4 sm:gap-8">
            {values.map((value, index) => (
              <div 
                key={value.title}
                className={`mobile-card rounded-lg p-4 sm:p-6 hover:border-red-500/40 transition-all duration-300 transform hover:scale-105 hover:bg-red-500/5 text-center ${
                  isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                }`}
              ...
              >
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-white mb-3 sm:mb-4 mobile-heading">{value.title}</h3>
        ...
        <div className={`mb-8 sm:mb-16 transition-all duration-1000 delay-800 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="mobile-card rounded-lg p-4 sm:p-8">
            <h2 className="text-xl sm:text-3xl font-bold text-white mb-4 sm:mb-6 text-center mobile-heading">What We Do</h2>
            <div className="grid md:grid-cols-2 gap-4 sm:gap-8">
              <div>
                <h3 className="text-lg sm:text-xl font-semibold text-red-500 mb-3 sm:mb-4">Creativity</h3>
                <ul className="space-y-2 sm:space-y-3 text-gray-300">
                  <li className="flex items-start space-x-2">
                    <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                    <span className="text-sm sm:text-base">Professional music production and mastering services</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                    <span className="text-sm sm:text-base">Global distribution across all major streaming platforms</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                    <span className="text-sm sm:text-base">Marketing and promotional support</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                    <span className="text-sm sm:text-base">Creative development and guidance</span>
                  </li>
                </ul>
              </div>
              <div>
                <h3 className="text-lg sm:text-xl font-semibold text-red-500 mb-3 sm:mb-4">Web Technology</h3>
                <ul className="space-y-2 sm:space-y-3 text-gray-300">
                  <li className="flex items-start space-x-2">
                    <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                    <span className="text-sm sm:text-base">Complete infrastructure and backend support</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                    <span className="text-sm sm:text-base">Technology solutions and digital platforms</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                    <span className="text-sm sm:text-base">Business development and partnership opportunities</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                    <span className="text-sm sm:text-base">Access to our global network and resources</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className={`text-center transition-all duration-1000 delay-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h2 className="text-xl sm:text-3xl font-bold text-white mb-4 sm:mb-6 mobile-heading">Ready to Join Our Community?</h2>
