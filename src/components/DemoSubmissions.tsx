      ...
      <div className="max-w-6xl mx-auto px-2 sm:px-4 w-full">
        ...
        <div className={`text-center mb-6 sm:mb-12 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h1 className="text-2xl sm:text-4xl md:text-6xl font-bold mb-4 sm:mb-6 mobile-heading">
            ...
            <span className="text-red-500 ml-2 sm:ml-4">SUBMISSIONS</span>
          </h1>
          <div className="w-16 sm:w-24 h-1 bg-red-500 mx-auto mb-4 sm:mb-8"></div>
          <h2 className="text-lg sm:text-2xl md:text-3xl text-gray-300 font-semibold mobile-text-shadow px-2">
        ...
        <div className={`transition-all duration-1000 delay-300 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="w-full max-w-4xl mx-auto mb-6 sm:mb-8">
            <div className="mobile-card rounded-lg p-2 sm:p-4">
              <iframe 
                id="upload-iframe" 
        ...
        <div className={`text-center transition-all duration-1000 delay-500 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="mobile-card rounded-lg p-4 sm:p-6 max-w-md mx-auto">
            <h3 className="text-lg sm:text-xl font-semibold text-white mb-3 sm:mb-4 mobile-heading">Alternative Submission Method</h3>
            <a 
            ...
            >
              ...
              <span className="text-base sm:text-lg font-medium">submit@rt8.co.za</span>
            </a>
